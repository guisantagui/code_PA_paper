...
colThick <- set(allMetsHeatMap$colDendrogram, "branches_lwd", 1)
rowThick <- set(allMetsHeatMap$rowDendrogram, "branches_lwd", 1)
...
mets_ccmn_med_pca <- prcomp(mets_ccmn_med)
